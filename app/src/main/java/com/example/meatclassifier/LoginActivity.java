...
//        }
        authProfile.signInWithEmailAndPassword(userEmail,userPass).addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()) {
                    ...
                    if(firebaseAuth.getCurrentUser().isEmailVerified()) {
                        ...
                        Toast.makeText(LoginActivity.this,"You have not verified your Gmail ID \n Verify Your Gmail ID to Login" , Toast.LENGTH_SHORT).show();
                    }
                } else{
                    try {
    ...
    private boolean isConnected(LoginActivity login_page) {
